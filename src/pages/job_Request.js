...
//                       <select
//                         value={app.status}
//                         disabled={["Pending", "Selected", "Rejected"].includes(app.status)}
...
const HRJobDashboard = () => {
  ...
  const updateJobStatus = async (id, status) => {
    try {
      const res = await axios.put(`${API_URL}/job-requests/${id}/status`, { status });
              ...
              {applications.map(app => (
                <tr key={app.id}>
                  ...
                  <td>
                    <button
                      className="btn btn-warning btn-sm"
                      onClick={() => updateJobStatus(app.id, "Pending")}
                      disabled={app.status === "Pending"}
                    >
                      Reset
                    </button>
